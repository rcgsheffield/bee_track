...
class Rotate(Configurable):
    ...
    def __init__(self, message_queue):
        ...
        "This event is signalled when we receive a rotation angle"
    ...
    def worker(self):
        """
        Wait for a rotation signal, then calculate the rotation angle and tell the motor to move.
        """
        self.currentangle = 0
        self.stepcounter = 0
        ...
        while True:
            ...
            # Calculate the angle through which to rotate
            ...
            # ramplength = 10
            # stepsperloop = 30
            totalsteps = int(abs(angletorotate) * (
                    32.0 * 200 / 360))  # number of steps 200=complete turn in full mode, so at 1/32 -> 6400
